...
POLICY_SCHEMA = "arena.policy/v0alpha1"
MATCH_SCHEMA = "arena.match/v0alpha1"
TRAJECTORY_SCHEMA = "arena.trajectory/v0alpha1"
RUN_SCHEMA = "arena.run/v0alpha1"
POPULATION_SCHEMA = "arena.population/v0alpha1"
EVALUATION_SCHEMA = "arena.evaluation/v0alpha1"
EVAL_RUN_SCHEMA = "arena.eval-run/v0alpha1"
EVAL_REPORT_SCHEMA = "arena.eval-report/v0alpha1"
EVALUATION_INTENT_SCHEMA = "arena.evaluation-intent/v1"
EVALUATION_BINDING_SCHEMA = "arena.evaluation-binding/v1"
EVAL_RUN_V1_SCHEMA = "arena.eval-run/v1"
EVAL_REPORT_V1_SCHEMA = "arena.eval-report/v1"
DATASET_SCHEMA = "arena.dataset/v0alpha1"
EVAL_BUNDLE_SCHEMA = "arena.eval-bundle/v0alpha1"
...
def validate_policy_manifest(data: dict[str, Any]) -> dict[str, Any]:
    ...
    if data.get("runtime", {}).get("adapter") == "custom-pytorch":
        from arena.core.contracts import validate_architecture_spaces
...
def evaluation_content_digest(data: dict[str, Any]) -> str:
    ...
    artifacts produced by earlier Arena releases.
    """
...
def task_intent_projection(task: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema": "arena.task-intent/v1",
        "canonicalization": "arena-canonical-json/v1",
        "semantics": projected,
    }
