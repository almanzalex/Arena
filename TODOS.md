...
| Hosted accounts/catalog/control plane | Changes Arena from local protocol/tooling into a service business; see [RFC 012](rfcs/012-hosted-control-plane.md) (deferred; local `arena catalog local` stub only) | Repeated user demand cannot be met by user-owned stores |
