...
**Local-first interoperability for reinforcement-learning artifacts.**
...
Arena sits in the gap: **verify that a policy, task, population, and evaluation
claim can be composed and reproduced on a clean machine.**
