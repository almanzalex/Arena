...
RLX owns recipe identity, dataset integrity, output policy conformance, and run
...
from rlx.core.registry import TRAINERS
...
class BehaviorCloningTrainer:
    ...
    def run(
        ...
        *,
        ...
        from rlx.runtime.training import _run_categorical_recipe
