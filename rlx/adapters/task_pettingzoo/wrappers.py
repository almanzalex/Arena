...
or unknown wrappers fail loud via the wrapper-op registry; RLX never silently
...
from rlx.core.registry import WRAPPER_OPS, ensure_plugins_loaded
from rlx.plugins.wrappers import require_supersuit, resolve_wrapper_kind
    ...
    for i, step in enumerate(steps):
        ...
        try:
            ...
            raise RlxError(
                ...
                "RLX will not fall back to the unwrapped environment."
            ) from e
    return env
