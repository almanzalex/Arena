"""Task import and semantic trace-equivalence operations (RLX 0.3)."""
...
from rlx.adapters.task_openenv.adapter import PILOT_CONTRACT, PILOT_ENV
...
def import_openenv_task(
    ...
    *,
    ...
    """Pin an OpenEnv endpoint plus the RLX role-space contract it cannot infer."""
    ...
    if contract_path is not None:
        ...
        raise SchemaError(
            "OpenEnv JSON Schema does not define RLX per-role Gym spaces; "
...
def verify_task_equivalence(
    ...
    result = {
        "schema": "rlx.equivalence-report/v1",
        "ok": not diffs,
