...
| Hosted accounts/catalog/control plane | Changes RLX from local protocol/tooling into a service business | Repeated user demand cannot be met by user-owned stores |
...
| Sandboxing untrusted Python/providers | Process isolation is not an OS security sandbox | RLX accepts a threat model requiring adversarial-code execution |
