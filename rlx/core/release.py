...
from rlx.core.attestation import _crypto, public_key_id
from rlx.core.errors import ConformanceError, SchemaError
from rlx.core.identity import canonical_json, digest_uri, parse_digest, sha256_bytes, sha256_file
from rlx.core.manifests import dump_json, load_manifest

EVIDENCE_SCHEMA = "rlx.release-evidence/v1"
SIGNATURE_SCHEMA = "rlx.detached-signature/v1"
CURRENT_SCHEMA = "rlx.qualification-ledger/v1"
...
def verify_release_evidence(
    ...
    *,
    ...
    return {
        "schema": "rlx.release-verification/v1",
        "ok": True,
