...
from arena.core.registry import PAYLOAD_LOADERS
...
class TemplatePayload:
    ...
    def load_module(
        ...
        *,
        ...
        del trust_source
        from arena.adapters.policy_custom_torch import _require_torch, build_module
...
def _import_pinned_source(src_path: Path, *, attr: str) -> Any:
    ...
    mod_name = f"arena_trusted_source_{sha256_file(src_path)[:12]}"
...
def export_trusted_source_bundle(
    *,
    ...
    from arena.adapters.policy_custom_torch.preprocess import canonical_pipeline
    from arena.core.action_cases import action_type, box_distribution
    from arena.core.contracts import validate_architecture_spaces, validate_reference_case_action
