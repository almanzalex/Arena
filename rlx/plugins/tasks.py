...
from rlx.core.registry import TASK_PACKAGERS
...
class EntrypointBundlePackager:
    ...
    def make_env(self, spec: dict[str, Any], *, trust_task_code: bool = False) -> Any:
        ...
        if wrappers:
            from rlx.adapters.task_pettingzoo.wrappers import apply_wrappers
...
def _import_pinned_source(src_path: Path, *, attr: str) -> Any:
    mod_name = f"rlx_entrypoint_{sha256_file(src_path)[:12]}"
