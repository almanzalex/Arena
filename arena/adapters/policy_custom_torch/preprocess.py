...
from arena.core.registry import PREPROCESS_OPS, ensure_plugins_loaded


class PreprocessPipeline:
    """Execute ``arena.preprocess/v1`` without implicit reshapes or coercions."""
    ...
    def __init__(self, spec: dict[str, Any], observation: dict[str, Any]) -> None:
        ...
        version = spec.get("pipeline", {}).get("version", "arena.preprocess/v1")
        if version != "arena.preprocess/v1":
...
def canonical_pipeline(
    ...
    return {
        ...
        "pipeline": {"version": "arena.preprocess/v1", "steps": steps},
    }
